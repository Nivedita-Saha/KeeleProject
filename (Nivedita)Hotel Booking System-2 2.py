...
# Function to load room data from CSV file
def load_room_data():
    rooms = {}
...
# Function to load reservations from CSV file
...
def load_reservations():
    ...
    try:
        ...
        if reservations:  # If reservations are found, set reference_id_counter accordingly
...
# Function to save reservations to CSV file
...
# Additional utility functions required for booking and cancellation
